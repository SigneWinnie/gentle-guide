package com.isj.schedulemanagement.service;

import com.isj.schedulemanagement.model.Schedule;
import com.isj.schedulemanagement.repository.ScheduleRepository;
...
public class ScheduleService {
    ...
    public Schedule updateSchedule(Long id, Schedule scheduleDetails) {
        ...
        schedule.setCourseId(scheduleDetails.getCourseId());
